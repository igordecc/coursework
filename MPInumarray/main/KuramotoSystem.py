...
class KuramotoSystem:
    ...
    def __init__(self, omega_vector, lambd, A, phase_vector, t0, tf, N, oscillators_number):
        ...
        for i in range(self.oscillators_number):
            self.vfunc.append(Pendulum(lambd, A, omega_vector[i], self.oscillators_number))
...
class Pendulum:
    def __init__(self, lambd, A,  omega, oscillators_number):  # lambd -- A[i]
        """
    ...
    def __call__(self, index, phase_vector):
        """
