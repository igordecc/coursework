...
def test_computeSystemOCL():
    pendulum_phase_output_array, pendulum_time_output_array, time_output_array_length = shell.compute_system_ocl(osc_min=10, osc_max=100, osc_step=1)
...
def test_computeRLSystemOCL():
    #print(shell.compute_r_for_multiple_lambda_ocl())
    RLArray = shell.compute_r_for_multiple_lambda_ocl()
    ln = len(RLArray)
